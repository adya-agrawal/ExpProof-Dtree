...
# CONFIG
# --------------------------------------------
NN_LAYERS = [2, 4, 8, 16]            # neural network depths
TREE_DEPTHS = [3, 4, 5, 6, 7, 8]        # decision tree depths
SAVE_ROOT = "experiments"          # save trained networks
...
def run_experiments_for_dataset(dataset_name, loader_fn):
    ...
    # --------------------------------------------
    # LOOP OVER NEURAL NETWORK DEPTHS
    # --------------------------------------------
    for L in NN_LAYERS:
